...
public class AnswerAdapter_old extends ArrayAdapter<Answer> {
    ...
    public AnswerAdapter_old(Context context, ArrayList<Answer> answers) {
        super(context, 0, answers);
    }

    public AnswerAdapter_old(Context context, ArrayList<Answer> answers, String questionState) {
        super(context, 0, answers);
